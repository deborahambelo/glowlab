...
const SKINCARE_DATA = {
      ...
      Treatment: [
        {
          ...
          benefit:
            "OTC retinoid that clears breakouts and prevents future ones",
        },
        {
          brand: "Rx Only",
    ...
    products: {
      ...
      Sunscreen: [
        ...
        },
        {
          ...
          name: "Ultra Sheer SPF 50",
          key: "UVA/UVB filters",
          benefit: "Lightweight daily shield non-negotiable for pigmentation",
        },
      ],
    },
    routine: {
      ...
      "Hydrating Serums": [
        {
          ...
          key: "Hyaluronic Acid",
          benefit: "Draws moisture deep into skin — apply on damp skin",
        },
        {
          brand: "Vichy",
      ...
      Moisturizers: [
        {
          ...
          name: "Hydro Boost Water Gel",
          key: "Hyaluronic Acid",
          benefit: "Fast-absorbing gel for dehydrated combination skin",
        },
        {
          brand: "CeraVe",
          name: "Moisturizing Cream",
      ...
      "Night Occlusives": [
        {
          ...
          key: "Petrolatum",
          benefit: "Ultimate moisture seal overnight — 'slugging' method",
        },
        {
          brand: "Aquaphor",
          name: "Healing Ointment",
          key: "Petrolatum + Panthenol",
          benefit: "Repairs very dry, cracked areas overnight",
        },
      ],
    },
    routine: {
  ...
  antiaging: {
    ...
    bg: "#faf5ff",
    description:
      "Fine lines, loss of firmness, uneven texture from collagen breakdown and UV damage over time.",
    causes: [
      "UV damage — the #1 cause of premature aging",
      ...
      Retinoids: [
        {
          ...
          key: "Adapalene",
          benefit: "Boosts cell turnover and collagen — reduces fine lines",
        },
        {
          brand: "RoC",
          name: "Retinol Correxion Serum",
          key: "Retinol 0.5%",
          benefit: "Firms skin and smooths texture over 12 weeks",
        },
      ],
      "Vitamin C": [
        {
          ...
          key: "L-Ascorbic Acid 20%",
          benefit: "Neutralises free radicals, firms, and brightens skin",
        },
      ],
      Sunscreen: [
        {
          ...
          name: "Ultra Sheer SPF 50",
          key: "Broad Spectrum",
          benefit: "Prevents 80%+ of visible aging — most important step",
        },
      ],
    },
    routine: {
      ...
      tips: [
        "SPF is the best anti-aging product available — full stop",
        "Vitamin C in the morning, retinoid at night — never mix",
        "Retinoids take 3–6 months to see real collagen results",
        "Consistency over 6–12 months is what transforms skin",
      ],
    },
  },
  sensitivity: {
    ...
    bg: "#fdf2f8",
    description:
      "Reactive skin with visible redness, flushing, or rosacea — barrier is often impaired.",
    causes: [
      "Rosacea (genetic)",
      "Compromised skin barrier",
      "Harsh or fragranced products",
      "Temperature changes and spicy foods",
    ],
    ingredients: [
      "Centella Asiatica",
      "Azelaic Acid (gentle)",
      ...
      Cleansers: [
        {
          ...
          key: "Prebiotic water",
          benefit: "Zero-irritant — specifically formulated for rosacea",
        },
        {
          brand: "Avène",
          name: "Extremely Gentle Cleanser",
          key: "Avène Thermal Water",
          benefit: "Calms reactivity and redness while cleansing",
        },
      ],
      Treatments: [
        {
          ...
          key: "Azelaic Acid",
          benefit: "Reduces redness, rosacea symptoms, and PIH gently",
        },
      ],
      Moisturizers: [
        {
          ...
          name: "Moisturizing Cream",
          key: "Fragrance-free",
          benefit: "Hypoallergenic — trusted for rosacea and eczema",
        },
        {
          brand: "La Roche-Posay",
          name: "Toleriane Double Repair",
          key: "Ceramides + Niacinamide",
          benefit: "Rebuilds barrier and visibly reduces redness",
        },
      ],
    },
    routine: {
      AM: [
        "Gentle rinse or non-foaming cleanser",
      ...
      tips: [
        "Patch test everything before applying to full face",
        "Mineral SPF is less irritating than chemical for rosacea",
        "Avoid fragrance, alcohol, menthol, and witch hazel",
        "Simplify your routine — fewer products = fewer triggers",
      ],
    },
  },
  pores: {
    ...
    bg: "#f0f9ff",
    description:
      "Visibly enlarged pores — mostly on T-zone. Can appear significantly smaller with the right actives.",
    causes: [
      "Excess sebum stretching pores",
      "Genetics",
      "Sun damage reducing elasticity",
      "Clogged debris inside pores",
    ],
    ingredients: [
      "Salicylic Acid (BHA)",
      "Niacinamide",
      ...
      Exfoliants: [
        {
          ...
          name: "BHA 2% Skin Perfecting Liquid",
          key: "Salicylic Acid 2%",
          benefit: "Exfoliates inside the pore lining — best BHA available",
        },
        {
          brand: "CeraVe",
          name: "Salicylic Acid Cleanser",
          key: "Salicylic Acid",
          benefit: "Gentle daily option to prevent congestion",
        },
      ],
      Serums: [
        {
          ...
          key: "Niacinamide",
          benefit: "Regulates oil and visibly minimises pore appearance",
        },
      ],
      Sunscreen: [
        {
          ...
          name: "Oil Control SPF 30",
          key: "Mattifying Silica",
          benefit: "Absorbs excess oil that makes pores appear larger",
        },
      ],
    },
    routine: {
      ...
      PM: [
        "Oil cleanser then water cleanser (double cleanse)",
        "BHA 3–4× per week",
        "Moisturizer",
      ],
      tips: [
        "Never skip cleansing — congested pores look larger",
        "Retinoids tighten pore appearance long-term via collagen",
        "BHA is oil-soluble — it dissolves the debris inside pores",
        "Mattifying SPF minimises midday shine and visible pores",
      ],
    },
  },
};
    ...
    <div className="fade-up">
      ...
      >
        {[
          ...
          >
            <div className="serif" style={{ fontSize: 36, color: "#1a1a1a" }}>
              {s.n}
            </div>
            <div
              style={{
      ...
      >
        ...
        >
          ...
          >
            6 concerns with causes, ingredients, curated products, and full
            routine guides.
          </p>
  ...
  return (
    <div className="fade-up" style={{ paddingTop: 52, paddingBottom: 80 }}>
      ...
      <div style={{ marginBottom: 46 }}>
        ...
        >
          Select a concern to get causes, hero ingredients, curated product
          picks, and your full AM/PM routine.
        </p>
      </div>
      ...
      >
        {Object.values(SKINCARE_DATA).map((c) => (
          <div
            ...
            style={{
              borderColor: activeConcern === c.id ? c.color : undefined,
              boxShadow:
                activeConcern === c.id ? `0 0 0 3px ${c.color}15` : undefined,
            }}
            onClick={() =>
              setActiveConcern(activeConcern === c.id ? null : c.id)
            }
          >
            <div
              style={{
            ...
            {activeConcern === c.id && (
              ...
              >
                <span style={{ fontSize: 11, color: c.color, fontWeight: 700 }}>
                  ✓ Viewing guide below
                </span>
              </div>
            )}
  ...
  return (
    <div className="fade-up" style={{ paddingTop: 52, paddingBottom: 80 }}>
      ...
      <div style={{ marginBottom: 46 }}>
        ...
        >
          Each group includes exercises with sets, reps, level, coaching cues,
          and a pro tip. Log in to save to your weekly plan.
        </p>
      </div>
      ...
      >
        {Object.values(FITNESS_DATA).map((m) => (
          <button
            key={m.id}
            className={`muscle-btn ${activeMuscle === m.id ? "active" : ""}`}
            onClick={() => {
              setActiveMuscle(activeMuscle === m.id ? null : m.id);
              setExpandedEx(null);
            }}
          >
      ...
      {muscle && (
        <div className="expand-body" key={muscle.id}>
          <div
            style={{
              padding: "18px 22px",
              background: `${muscle.color}10`,
              borderRadius: 14,
              border: `1.5px solid ${muscle.color}22`,
              marginBottom: 24,
              display: "flex",
              gap: 14,
          ...
          >
            ...
            <div>
              <div
                className="label"
                style={{ color: muscle.color, marginBottom: 5 }}
              >
                Coach Tip
              </div>
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
                <span
                  className="tag"
                  style={{
                    background: ex.level === "Beginner" ? "#ecfdf5" : "#fef3c7",
                ...
                <button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    if (!user) setShowAuth(true);
                    else addToWorkout(ex.name, muscle.label);
                  }}
                >
                  + Plan
                </button>
      ...
      >
        <div>
          ...
          >
            Build your{" "}
            <span className="italic" style={{ color: "#fb923c" }}>
              weekly split.
            </span>
          </h3>
          <p style={{ fontSize: 13, color: "#9ca3af", maxWidth: 360 }}>
            Log in to save exercises across all muscle groups and build a
      ...
      {post ? (
        ...
        <>
          <div style={{ marginBottom: 44 }}>
            ...
            >
              Evidence-based reads on skincare ingredients, routines, and
              training principles.
            </p>
          </div>
          <div
            ...
            {BLOG_POSTS.map((p, i) => (
              ...
              >
                <span
                  className="tag"
                  style={{
                    background: p.cat === "Skincare" ? "#fce7f3" : "#fff7ed",
                    color: p.cat === "Skincare" ? "#be123c" : "#c2410c",
                    marginBottom: 14,
                    display: "inline-block",
                  }}
                >
                ...
                >
                  ...
                  <span
                    style={{ fontSize: 12, color: "#f43f5e", fontWeight: 600 }}
                  >
                    Read · {p.read} →
                  </span>
                </div>
  ...
  if (!user)
    return (
      <div style={{ paddingTop: 80, textAlign: "center" }}>
        ...
        <p style={{ fontSize: 14, color: "#9ca3af", marginBottom: 26 }}>
          Save routines and track your workout plan.
        </p>
        <button className="btn btn-rose" onClick={() => setPage("home")}>
          ← Back to Home
        </button>
      </div>
    );
    ...
    >
      ...
      >
        ...
        >
          ...
          <span
            className="serif"
            style={{ fontSize: 18, color: "#1a1a1a", letterSpacing: "-0.02em" }}
          >
            glow
            <span className="italic" style={{ color: "#f43f5e" }}>
              lab
        ...
        <div style={{ display: "flex", gap: 4 }}>
          {[
            { id: "home", l: "Home" },
            { id: "skincare", l: "✦ Skincare" },
            { id: "fitness", l: "◈ Fitness" },
            { id: "blog", l: "Blog" },
          ].map((link) => (
            <button
              key={link.id}
